...
class SrHeader extends StatefulWidget {
  SrHeader({super.key, required this.replyer, required this.replyerDesc});
...
class SrHeaderState extends State<SrHeader> with TickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
  ...
  @override
  void didUpdateWidget(covariant SrHeader oldWidget) {
